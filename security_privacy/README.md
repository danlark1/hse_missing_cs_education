...
GSM сети &mdash; одни из самых небезопасных протоколов в мире, который и ещё сложно
поменять. Не пользуйтесь им, в том числе и для двухфакторной аутентификации.
