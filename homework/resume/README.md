...
<p align="center">
  <img src="./media/github-pages.png" />
</p>

Github Pagse позволяет сделать содержимое Ваших репозиторией доступным по ссылке. Подробнее можно ознакомиться [здесь](https://pages.github.com/).

Чтобы получить доступ к github pages в приватных репозиториях, необходимо получить статус PRO. Это можно сделать, получив [Github Student Developer Pack](https://education.github.com/pack): подайте заявку, указав учебную почту @edu.hse.ru и прикрепив фотографию студенческого билета. Если нет возможности подать заявку на Student Pack, публикуйте PDF в отдельный публичный репозиторий.
...
* **Сдать эту ссылку в [форму](https://forms.gle/gWi3AaWAScMZdhpR6).**
...
- 2 балла за workflow, проверяющий сборку.
...
1. Ваше ФИО.
3. Ссылка на github pages с Вашим резюме, если вы делали этот пункт.
