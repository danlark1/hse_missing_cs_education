...
*TODO: ссылка на лекцию про докер*

*можно вставить команды с дз по resume*
...
P.S. Вот, что получилось у меня: [@queryboba_bot](https://t.me/queryboba_bot) [Отвечает только на инлайн команды]
...
TODO: добавить коллабораторов, заполнить гугл форму.