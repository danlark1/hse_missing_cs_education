...
4. Если вы реализовали автоматический запуск бота на сервере, опишите ваше решение. Если использовали WatchTower, прикрепите содержимое docker-compose файла.
