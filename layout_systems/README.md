...
* Можно вставлять ссылки: [Search for it.](www.google.com) как
...
второе свое поделие Metafont, это язык для описания шрифтов. Сейчас шрифты
...
видете результаты и их изменения. TeX вычисляет всё, в том числе и может легко
