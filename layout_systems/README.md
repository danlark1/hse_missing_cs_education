...
курсу алгоритмов и структур данных, Дональд Кнут, он решил, что писать книж
ки в таком формате безумно сложно. Его томы всё равно были написаны как и
...
Формально TeX &mdash; это интерпретируемый язык программирования, все буквы, команды
это формально команды `напечатай что-то тут`. Формально LaTeX &mdash; это лишь
...
второе свое поделие &mdash; Metafont. Сейчас шрифты
...
печати и выстраивании логики.

В LaTeX также можно делать презентации, для этого есть специальный пакет [Beamer](https://ru.wikipedia.org/wiki/Beamer_(LaTeX)).
