...
критериев. Лекции будут записываться и выкладываться на youtube по ссылке TODO.
Единственные преимущества быть на лекции -- возможность задавать вопросы лично и
...
опечаток в конспектах или хорошие замечания, могут рассчитывать на автоматы,
человеку, который найдёт, исправит больше всего опечаток и дополнит интересно
лекции (а я приму pull request), полагается автомат.
